...
#Check if /etc/squid/squid.conf.origin exist
# if [ -f /etc/squid/squid.conf.origin ]
# then
#         echo "File /etc/squid/squid.conf.origin exist"
#         #Erase file config
#         cp /etc/squid/squid.conf.origin /etc/squid/squid.conf
...
#         echo "File /etc/squid/squid.conf.origin doesn't exist"
#         cp /etc/squid/squid.conf /etc/squid/squid.conf.origin
